...
-(void)initControl
{
    ...
    backImageView.image = [UIImage imageNamed:@"lyjbjt.png"];
    ...
    self.audioPower = [[UIProgressView alloc] initWithFrame:CGRectMake(20, 200*HEIGHT/667, WIDTH-40, 2)];
    [self.audioPower setProgressViewStyle:UIProgressViewStyleDefault];
    [self.view addSubview:self.audioPower];
    
    self.record = [[UIButton alloc] initWithFrame:CGRectMake(33*WIDTH/375, 470*HEIGHT/667, 52*WIDTH/375, 52*HEIGHT/667)];
    [self.record setBackgroundImage:[UIImage imageNamed:@"lyj_bfq_bfan"] forState:UIControlStateNormal];
    [self.record setBackgroundImage:[UIImage imageNamed:@"lyj_lyan"] forState:UIControlStateHighlighted];
    ...
    self.pause = [[UIButton alloc] initWithFrame:CGRectMake(118*WIDTH/375, 470*HEIGHT/667, 52*WIDTH/375, 52*HEIGHT/667)];
    [self.pause setBackgroundImage:[UIImage imageNamed:@"lyj_atan"] forState:UIControlStateNormal];
    [self.pause setBackgroundImage:[UIImage imageNamed:@"lyj_luzhian"] forState:UIControlStateHighlighted];
    ...
    self.resume = [[UIButton alloc] initWithFrame:CGRectMake(203*WIDTH/375, 470*HEIGHT/667, 52*WIDTH/375, 52*HEIGHT/667)];
    [self.resume setBackgroundImage:[UIImage imageNamed:@"lyj_bfq_bfan"] forState:UIControlStateNormal];
    [self.resume setBackgroundImage:[UIImage imageNamed:@"lyj_luzhian"] forState:UIControlStateHighlighted];

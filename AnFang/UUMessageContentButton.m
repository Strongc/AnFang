...
{
    NSString *path1 = [[NSBundle mainBundle] pathForResource:@"chat_animation_white3.png" ofType:nil];
    NSString *path2 = [[NSBundle mainBundle] pathForResource:@"chat_animation_white1.png" ofType:nil];
    NSString *path3 = [[NSBundle mainBundle] pathForResource:@"chat_animation_white2.png" ofType:nil];
    NSString *path4 = [[NSBundle mainBundle] pathForResource:@"chat_animation_white3.png" ofType:nil];
    ...
    if (self) {
        ...
        self.voice = [[UIImageView alloc]initWithFrame:CGRectMake(120, 5, 20, 20)];
        self.voice.image = [UIImage imageWithContentsOfFile:path1];
        self.voice.animationImages = [NSArray arrayWithObjects:
                                      [UIImage imageWithContentsOfFile:path2],
                                      [UIImage imageWithContentsOfFile:path3],
                                      [UIImage imageWithContentsOfFile:path4],nil];

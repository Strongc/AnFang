//
//  VideoListTabBarViewController.m
//  AnBao
//
...
#import "VideoListTabBar.h"
#import "Common.h"
#import "UIColor+Extensions.h"

@interface VideoListTabBarViewController ()<UIScrollViewDelegate,VideoListTabBarDelegate>
{
    NSInteger       _currentIndex;              // current page index
    NSMutableArray  *_titles;                   // array of children view controller's title
    
    VideoListTabBar  *_navTabBar;                // NavTabBar: press item on it to exchange view
...
@implementation VideoListTabBarViewController
...
- (void)viewInit
{
    ...
    _navTabBar = [[VideoListTabBar alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 30*HEIGHT/667) showArrowButton:_showArrowButton];
    
    _navTabBar.delegate = self;
    //_navTabBar.backgroundColor = _navTabBarColor
    _navTabBar.backgroundColor = [UIColor colorWithHexString:@"ededed"];

...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        ...
        self.btnChangeVoiceState.frame = CGRectMake(20, 5, 50*WIDTH/375, 50*HEIGHT/667);
        ...
        self.btnVoiceRecord.frame = CGRectMake(80,70,WIDTH-160, 40);
        self.btnVoiceRecord.hidden = YES;
        [self.btnVoiceRecord setBackgroundImage:[UIImage imageNamed:@"chat_message_back.png"] forState:UIControlStateNormal];
        ...
        [self.btnVoiceRecord setTitle:@"放开完成录音" forState:UIControlStateHighlighted];

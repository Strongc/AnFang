...
@implementation VideoListTabBar
...
{
    CGFloat buttonX = 20*WIDTH/375;
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
         button.frame = CGRectMake(buttonX, -5, [widths[index] floatValue]*WIDTH/375, 44*WIDTH/375);
